...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Salt Shaker - saltstack - LEAP 15.5 $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Salt Shaker - saltstack - LEAP 15.5: Environment setup failed"
}
